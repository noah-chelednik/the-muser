...
PROMPT_LIBRARY: dict[str, list[TrackPrompt]] = {
    "pop": [
        TrackPrompt("pop", "Sunrise Boulevard",
        ...
        TrackPrompt("pop", "Electric Hearts",
        ...
        TrackPrompt("pop", "City Lights Instrumental",
    ...
    "rock": [
        ...
        TrackPrompt("rock", "Broken Glass",
            ...
            "of the performance."),
        TrackPrompt("rock", "Desert Highway",
        ...
        TrackPrompt("rock", "Midnight Drive",
        ...
        TrackPrompt("rock", "Autumn Leaves Fall",
    ...
    "jazz": [
        TrackPrompt("jazz", "Blue Moon Café",
        ...
        TrackPrompt("jazz", "Sunday Morning",
        ...
        TrackPrompt("jazz", "Harlem Nights",
        ...
        TrackPrompt("jazz", "Rainy Day Blues",
        ...
        TrackPrompt("jazz", "Autumn in Paris",
        ...
        TrackPrompt("jazz", "Modal Exploration",
    ...
    "electronic": [
        TrackPrompt("electronic", "Neon Pulse",
        ...
        TrackPrompt("electronic", "Deep Dive",
        ...
        TrackPrompt("electronic", "Binary Stars",
        ...
        TrackPrompt("electronic", "Circuit Break",
        ...
        TrackPrompt("electronic", "Crystal Caves",
        ...
        TrackPrompt("electronic", "Quantum Leap",
        ...
        TrackPrompt("electronic", "Aurora Waves",
        ...
        TrackPrompt("electronic", "Data Stream",
    ...
    "classical": [
        TrackPrompt("classical", "Morning Prelude",
        ...
        TrackPrompt("classical", "String Serenade",
        ...
        TrackPrompt("classical", "Nocturne in Blue",
        ...
        TrackPrompt("classical", "Symphony Fragment",
        ...
        TrackPrompt("classical", "Minuet in G",
        ...
        TrackPrompt("classical", "Elegy for Strings",
            ...
            "into acceptance."),
        TrackPrompt("classical", "Scherzo Brillante",
        ...
        TrackPrompt("classical", "Pastoral Scene",
    ...
    "r&b": [
        ...
        TrackPrompt("r&b", "Midnight Confession",
    ...
    "hiphop": [
        TrackPrompt("hiphop", "Block Party",
        ...
        TrackPrompt("hiphop", "Concrete Jungle",
        ...
        TrackPrompt("hiphop", "Empire State",
        ...
        TrackPrompt("hiphop", "Southside Groove",
        ...
        TrackPrompt("hiphop", "Midnight Cypher",
    ...
    "country": [
        TrackPrompt("country", "Dusty Trail",
            ...
            "country balladeers."),
        TrackPrompt("country", "Honky Tonk Saturday",
        ...
        TrackPrompt("country", "River Bend",
        ...
        TrackPrompt("country", "Broken Boots",
        ...
        TrackPrompt("country", "Wildflower",
        ...
        TrackPrompt("country", "Porch Swing Blues",
        ...
        TrackPrompt("country", "Harvest Moon Dance",
        ...
        TrackPrompt("country", "Tennessee Waltz",
...
def generate_batch(
    ...
    total_prompts = sum(
        min(num_per_genre, len(PROMPT_LIBRARY.get(g, []))) for g in genres
    )
    completed = 0
    ...
    for genre in genres:
        ...
        for i, prompt in enumerate(prompts[:num_per_genre]):
            ...
            logger.info(
                ...
                completed, total_prompts, genre, prompt.title, eta,
            )
            ...
            for round_idx in range(num_rounds):
                ...
                for j, wav_path in enumerate(paths):
                    ...
                    logger.info(
                        ...
                        len(candidate_scores), effective_best_of,
                        score, seed + j, gen_time / len(paths),
                    )
...
def main():
    parser = argparse.ArgumentParser(
        description="Batch audio generation using ACE-Step"
    )
    parser.add_argument(
        "--device", default="cuda",
    ...
    parser.add_argument(
        "--num-per-genre", type=int, default=8,
