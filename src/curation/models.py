...
class PipelineConfig(BaseModel):
    ...
    hard_gates: dict = Field(default_factory=lambda: {
    ...
    genre_weight_overrides: dict = Field(default_factory=lambda: {
        "cinematic": {"structure": 0.25, "evolution": 0.20, "rhythm": 0.15},
        "ambient": {"rhythm": 0.10, "structure": 0.10, "freq_balance": 0.25, "stereo_mix": 0.25},
    ...
    duplicate_detection: dict = Field(default_factory=lambda: {
        "cross_genre_threshold": 0.03,
        "within_genre_threshold": 0.06,
        "self_test": True,
    })

    packaging: dict = Field(default_factory=lambda: {
    ...
    postproduction: dict = Field(default_factory=lambda: {
        "genre_preset_map": {
            "cinematic": "classical",
            "classical": "classical",
    ...
    pack_prices: dict = Field(default_factory=lambda: {
        "cinematic": 24, "classical": 19, "classical_commercial": 19,
        "classical_expanded": 19, "pop": 19, "rock": 19, "electronic": 19,
        "lofi": 14, "ambient": 14, "rnb": 19, "ancient": 14,
        "dark_experimental": 14, "signature": 24,
    })
