...
MOOD_VOCAB = frozenset({
    "dramatic", "intense", "powerful", "calm", "peaceful", "melancholic",
    "upbeat", "energetic", "dark", "bright", "ethereal", "aggressive",
    "romantic", "mysterious", "triumphant", "nostalgic", "hopeful",
    "haunting", "playful", "majestic", "intimate", "bold", "dreamy",
    "rebellious", "warm", "cold", "epic", "gentle", "gritty", "smooth",
    "atmospheric", "climactic", "building", "emerging", "chill", "mellow",
    "relaxing", "driving", "jarring", "sharp", "vast", "sparse",
    "lush", "soaring", "brooding", "somber", "jubilant", "fierce",
    "tender", "raw", "polished", "hypnotic", "meditative", "suspenseful",
    "heroic", "tragic", "wistful", "serene", "ominous", "whimsical",
    "vibrant", "soulful", "cinematic", "personal", "conclusive",
})

# Instrument vocabulary
INSTRUMENT_VOCAB = frozenset({
    "piano", "guitar", "drums", "bass", "strings", "brass", "violin",
    "cello", "flute", "saxophone", "trumpet", "synth", "synthesizer",
    "organ", "harp", "clarinet", "oboe", "percussion", "timpani",
    "mandolin", "banjo", "accordion", "harmonica", "sitar", "tabla",
    "koto", "shamisen", "erhu", "didgeridoo", "bagpipes", "lute",
    "harpsichord", "vibraphone", "marimba", "xylophone", "glockenspiel",
    "woodwinds", "choir", "vocals", "voice", "808", "hi-hats", "kick",
    "pad", "oud", "shakuhachi", "taiko", "bansuri", "duduk", "zither",
    "electric_guitar", "acoustic_guitar", "double_bass",
})
